...
function Attach.init(core)
	...
	local function ProcessReq(module, functionName, func, priority, RunType)
		...
		entry[functionName]:insert(RunType, {
			["Function"] = func,
			["Priority"] = priority, 
	...
	core:addFunction("AttachBeforeRun", function(module, functionName, func, priority)
		return ProcessReq(module, functionName, func, priority, "BeforeRun")
	end)
	
	core:addFunction("AttachIntercept", function(module, functionName, func, priority)
		return ProcessReq(module, functionName, func, priority, "Run")
	end)
	
	core:addFunction("AttachAfterRun", function(module, functionName, func, priority)
		return ProcessReq(module, functionName, func, priority, "AfterRun")
	end)
