...
print("Please ensure you have a build with a raidRoleplay.lua (top script) in the src directory in the running directory")
...
local raidRoleplay = Instance.new("Script")
raidRoleplay.Name = "raidRoleplay"
remodel.setRawProperty(raidRoleplay, "Source", "String", remodel.readFile(path .. "/raidRoleplay.lua"))

local children = remodel.readDir(path)
removefromlist(children, "raidRoleplay.lua")
local mainscript = nil

writeChildren(raidRoleplay, path, children)
remodel.writeModelFile(raidRoleplay, "raidRoleplayBuild.rbxmx")